...
@RelationshipEntity(type = RelationShipTypes.LIKES)
public class LikeRelationShip {
	...
	public LikeRelationShip(User user, Offer target_offer, Date date) {
		super();
		this.user = user;
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		LikeRelationShip other = (LikeRelationShip) obj;
		if (id == null) {
			if (other.id != null)
				return false;
